...
import { CarbonCreditCreatedEvent } from "@/types/events";

// table header
const columns: Column<CarbonCreditCreatedEvent>[] = [
  {
    Header: "Credit ID",
    accessor: "tokenId",
  },
...
type CreditListProps = {
  events: CarbonCreditCreatedEvent[];
};

const CreditsCreationDataTable: FunctionComponent<CreditListProps> = ({
  events
}) => {
...
export default CreditsCreationDataTable;
