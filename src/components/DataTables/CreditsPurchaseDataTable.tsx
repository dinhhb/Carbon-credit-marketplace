...
import { CarbonCreditPurchasedEvent } from "@/types/events";
import { renderTimeCell } from "../common/TimeCell";

// table header
const columns: Column<CarbonCreditPurchasedEvent>[] = [
  {
    Header: "Credit ID",
    accessor: "tokenId",
  },
...
type CreditListProps = {
  events: CarbonCreditPurchasedEvent[];
};

const CreditsPurchaseDataTable: FunctionComponent<CreditListProps> = ({
  events
}) => {
...
export default CreditsPurchaseDataTable;
