...
const SelectGroupIsAuditor: React.FC<AccountMetaProps> = ({
  handleChange,
  hasError,
}) => {
  ...
  return (
    <div className="mb-4.5">
      <label className="mb-3 block text-sm font-medium text-black dark:text-white">
        Account type <span className="text-meta-1">*</span>
      </label>
      ...
      <div className="relative z-20 bg-transparent dark:bg-form-input">
        <select
          ...
          className={`relative z-20 w-full appearance-none rounded border  bg-transparent ${
            hasError
              ? "border-danger dark:border-form-danger focus:border-danger active:border-danger dark:focus:border-danger"
        ...
        >
          ...
          <option value="Auditor" className="text-body dark:text-bodydark">
            Auditor
          </option>
...
export default SelectGroupIsAuditor;
